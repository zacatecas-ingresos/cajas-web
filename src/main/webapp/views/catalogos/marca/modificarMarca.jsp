	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				...
				<span class="logo-lg"><b>Madificar Marcas</b></span>
			</a>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					<span style="color: #798c9c">Modificar Marca</span>
				</h1>
			</section>
								...
								<form id="form-marcas">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="inputAbreviatura"
												...
												data-placement="top" title="Ingrese Nueva Abreviatura de la Marca"
									...
									<div class="form-group">
										...
										<input type="text" 
												...
												data-toggle="tooltip"
												data-placement="top"
												title="Ingrese Nuevo nombre de la Marca"
												placeholder="Nombre" 
												required="required">
									</div>
